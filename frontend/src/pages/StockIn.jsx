...
import { fetchProducts, stockIn } from '../services/api'
...
const STOCK_IN_REASONS = ['New shipment from supplier', 'Customer return', 'Restock', 'Inventory correction']
...
function StockIn() {
  ...
  return (
    <div className="page-shell page-stockin">
      <AdinkraWatermark name="nyameDua" className="page-watermark stockin-watermark" />
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px', maxWidth: '400px', marginTop: '16px' }}>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="e.g. Received from supplier, PO number, etc."
          />
          <NotePresets options={STOCK_IN_REASONS} activeValue={notes} onSelect={setNotes} />
        </div>
